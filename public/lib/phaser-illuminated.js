        ...
        if(this.lighting){
            ...
            this.lighting.objects.forEach(function(o){
                if(o.topleft && o.bottomright){ //rect obj
                    o.topleft.x = o.originalX - this.x + this.lamp.distance*2;
                    o.topleft.y = o.originalY - this.y + this.lamp.distance*2;
                    o.bottomright.x = o.originalX + o.originalW - this.x + this.lamp.distance*2;
                    o.bottomright.y = o.originalY + o.originalH - this.y + this.lamp.distance*2;
                    o.syncFromTopleftBottomright();
                }else if(o.radius){ //disc obj
                    o.center.x = o.originalX - this.x + this.lamp.distance*2;
                    o.center.y = o.originalY - this.y + this.lamp.distance*2;
                }else if(o.a && o.b){ //line obj
                    o.a.x = o.originalStartX - this.x + this.lamp.distance*2;
                    o.a.y = o.originalStartY - this.y + this.lamp.distance*2;
                    o.b.x = o.originalEndX - this.x + this.lamp.distance*2;
                    o.b.y = o.originalEndY - this.y + this.lamp.distance*2;
                }else if(o.points){ //polygon
                    o.points.forEach(function(point, index){
                        point.x = o.originalData[index].x - this.x + this.lamp.distance*2;
                        point.y = o.originalData[index].y - this.y + this.lamp.distance*2;
                    }, this);
                }
            }, this);
